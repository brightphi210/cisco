...
import hero1 from '../Images/hero-right.webp'
import hero2 from '../Images/hero-right-2.webp'
import hero3 from '../Images/hero-right-3.webp'
...
const SectionOne = () => {
  ...
  return (
    <div className='relative'>
        ...
        {showSectionOne === true &&
            <section className='px-[15rem] py-20 text-black flex h-[80vh] bg-green-100 items-center '>
